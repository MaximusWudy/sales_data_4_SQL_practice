...
INSERT INTO "country_d" VALUES
    ...
    ('C̫te d''Ivoire','CI','CIV',384,'ISO 3166-2:CI','Africa','Sub-Saharan Africa','Western Africa',002,202,011),
    ...
    ('Cura̤ao','CW','CUW',531,'ISO 3166-2:CW','Americas','Latin America and the Caribbean','Caribbean',019,419,029),
    ...
    ('R̩union','RE','REU',638,'ISO 3166-2:RE','Africa','Sub-Saharan Africa','Eastern Africa',002,202,014),
    ...
    ('Saint Barth̩lemy','BL','BLM',652,'ISO 3166-2:BL','Americas','Latin America and the Caribbean','Caribbean',019,419,029),
